...
CREATE TABLE users (
    ...
    CONSTRAINT email_must_be_company_email CHECK (((email)::text ~* '^[^@]+@waec\.org\.ng'::text))
);
...
--
-- Name: customers_shipping_addresses fk_rails_03434abdec; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: customers_billing_addresses fk_rails_1acf477a07; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: customers_shipping_addresses fk_rails_24feede977; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: customers_billing_addresses fk_rails_32e2e952a9; Type: FK CONSTRAINT; Schema: public; Owner: -
--
